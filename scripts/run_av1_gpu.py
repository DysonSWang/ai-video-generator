...
print('='*60)
print('MuseTalk - musetalk_avatar1 (official avatar)')
print('='*60)
...
output_path = '/root/livetalking/av1_test_output.mp4'
...
# 5. 合成音频
print('\n[5] 合成音频...')
final_path = '/root/livetalking/av1_test_final.mp4'
